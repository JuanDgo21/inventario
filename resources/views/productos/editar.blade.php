    ...
    <div class="max-w-md mx-auto bg-white dark:bg-gray-800 p-6 rounded shadow mt-6">
        <form action="{{ route('productos.update', $producto->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nombre" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300 dark:bg-gray-700 dark:text-white" value="{{ $producto->nombre }}" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="subcategoria_id" class="block text-gray-700 dark:text-gray-200 font-bold mb-2">Subcategoría</label>
                <select name="subcategoria_id" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring focus:border-blue-300 dark:bg-gray-700 dark:text-white" required>
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('productos.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600 transition">Volver</a>
            </div>
        </form>
    </div>
</x-app-layout>